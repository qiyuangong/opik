...
import { AgentInsightsInternalClient } from "./api/resources/agentInsightsInternal/client/Client.js";
...
export class OpikApiClient {
    ...
    protected _agentInsightsInternal: AgentInsightsInternalClient | undefined;
    ...
    public get agentInsightsInternal(): AgentInsightsInternalClient {
        return (this._agentInsightsInternal ??= new AgentInsightsInternalClient(this._options));
    }
